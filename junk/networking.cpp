...
/* get the rtattr field */
    ...
    inet_addr(gateway);
    std::cout << std::bitset<32>(rtInfo->dstAddr.s_addr) << endl;
    std::cout << std::bitset<32>(rtInfo->gateWay.s_addr) << endl;
    std::cout << std::bitset<32>(inet_addr(gateway)) << endl;

    std::cout << std::bitset<32>(0xffffffff) << endl;


    long mask = rtInfo->dstAddr.s_addr ^ rtInfo->srcAddr.s_addr;
    //mask = 0xffffffff ^ rtInfo->dstAddr.s_addr ^ rtInfo->srcAddr.s_addr;
    cout << std::hex << mask << endl;

    //printf("%s\n", inet_ntoa(rtInfo->dstAddr.s_addr & (rtInfo->srcAddr.s_addr-1)));
